...
class VideoDownloader: KoinComponent {
    ...
    private fun parseEncryptedMp4MetadataFromHtml(html: String): Mp4? {
       val jsCode = Jsoup.parse(html)
        ...
        val decryptionKeySZLength = decryptionKeySZ.length
        Logger.debug("decryptionKeySZLength : ${decryptionKeySZLength}")                       
        ...
        val mediaSourcesZ = cryptoHelper.decryptString(encryptedMediaMetadataZ, decryptionKeyZ)
            .toObject<Video>()
            .mp4?.copy(
                slug = mediaMetadataZ.slug,
                md5_id = mediaMetadataZ.md5_id
            )
        
        Logger.debug("mediaSourcesZ : ${mediaSourcesZ}")
        Logger.debug("/////////////////////////////////////////////////////////////")
        ///////////////////////////////////////////////////////////////////////////////
